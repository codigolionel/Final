...
export default function Characters() {
    ...
    return (
        <div>
            ...
            <div className='two d-flex justify-content-between p-1' >
            <h2 className='tree d-flex justify-content-start m-4 text-opacity-25' >Filters</h2>            
            <img className='line d-none' src="./src/components/Navegation/filter-icon.svg" alt="Menu" onClick={()=>{setShow(!show)}}></img>
            </div>


            {show == false?"":    <form className={'row justify-content-between d-flex'}>
                {
            ...
            <section className='run container d-flex justify-content-center flex-wrap '>
                {
